...
<body>
  ...
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__logo">
      ...
      <h1 class="logo__text">Anticipation View</h1>
    </div>
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to Anticipation View.</h1>
      <h2 class="heading--secondary">Are you ready to write your own Memo with Powerfull Secret?</h2>
    </div>
